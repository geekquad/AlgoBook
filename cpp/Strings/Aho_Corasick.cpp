...
int out[MAXS]; // Output for each state
        ...
        char highestChar = 'z')
{
    ...
    for (int i = 0; i < words.size(); ++i)
    {
        ...
        out[currentState] |= (1 << i); // match of keywords[i] at currentState.
    }
...
int main()
{
    /* Let’s take an example to understand Aho-Corasick algorithm
        ...
        The time complexity of this algorithm is O(N+L+Z)
        N= Length of input of string/text
