...
# Hoax number: https://mathworld.wolfram.com/HoaxNumber.html
import math
...
# Function to calculate sum of digits of distinct prime factors of given number n and sum of digits of number n and
